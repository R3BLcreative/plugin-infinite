...
class R3bl_Wp_Admin {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      R3bl_Wp_Admin_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'r3bl-wp-admin';
	 ...
	 *
	 * - R3bl_Wp_Admin_Loader. Orchestrates the hooks of the plugin.
	 * - R3bl_Wp_Admin_i18n. Defines internationalization functionality.
	 * - R3bl_Wp_Admin_Admin. Defines all hooks for the admin area.
	 * - R3bl_Wp_Admin_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the R3bl_Wp_Admin_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    R3bl_Wp_Admin_Loader    Orchestrates the hooks of the plugin.
	 */
